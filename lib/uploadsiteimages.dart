...
class UploadSiteImagesPage extends StatefulWidget {
  @override
  _UploadSiteImagesPageState createState() => new _UploadSiteImagesPageState();
}

class _UploadSiteImagesPageState extends State<UploadSiteImagesPage> {
  File sampleImage;
